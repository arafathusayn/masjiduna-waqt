/**
 * WASM prayer times unit tests — mirrors tests/unit/prayers.test.ts
 * but uses the WASM-accelerated implementation.
 */
...
describe("WASM: Chittagong — MWL Hanafi, Feb 25 2026", () => {
...
describe("WASM: Chittagong — Karachi Hanafi, Feb 25 2026", () => {
...
describe("WASM: London — MWL Hanafi, Summer Solstice Jun 21 2026", () => {
  ...
  test("Fajr is 02:31 (±2 min, WASM direct approach)", () => {
    expect(
  ...
  test("Isha is 23:27 (±2 min, WASM direct approach)", () => {
    expect(
...
describe("WASM: New York — ISNA Hanafi, Dec 15 2026", () => {
  const config: PrayerTimeConfig = {
...
describe("WASM: Mecca — Umm al-Qura Hanafi, Feb 25 2026", () => {
  const config: PrayerTimeConfig = {
...
describe("WASM: Cairo — MWL Shafi, Jun 21 2022", () => {
  const config: PrayerTimeConfig = {
...
describe("WASM: Sydney — Karachi Hanafi, Dec 21 2026", () => {
  const config: PrayerTimeConfig = {
...
describe("WASM: Jakarta — Singapore Shafi, Dec 25 2023", () => {
  const config: PrayerTimeConfig = {
...
describe("WASM: Polar region — undefined sunrise/sunset", () => {
  const config: PrayerTimeConfig = {
...
describe("WASM: Sunset vs Maghrib with adjustment", () => {
...
describe("WASM: Hanafi vs Standard Asr difference", () => {
...
describe("WASM: Dhuhr adjustment", () => {
...
describe("WASM: elevation adjusts sunrise/sunset", () => {
